...
export default function NewPost() {
    ...
    return (
        <div className="min-h-screen bg-black">
            {/* Header - Desktop */}
            <div className="hidden md:block sticky top-0 bg-black/20 backdrop-blur-md border-b border-white/20 p-4 z-10 md:px-12">
            ...
            {/* Merged Navbar - Mobile Only */}
            <div className="md:hidden sticky top-0 z-40 flex items-center justify-between h-12 bg-black/80 backdrop-blur border-b border-white/10 px-4">
                <button
                    onClick={() => router.back()}
                    className="text-gray-400 hover:text-white transition-colors"
                >
